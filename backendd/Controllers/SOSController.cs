...
namespace backendd.Controllers
{
    ...
    public class SOSController : ControllerBase
    {
        ...
        {
            var sosLogs = await _sosService.GetAllSOSLogsAsync();
            return Ok(sosLogs);
        }
        ...
        {
            var sosLog = await _sosService.GetSOSLogByIdAsync(id);
        ...
        {
            var createdSOSLog = await _sosService.AddAsync(sosLog);
        ...
        {
            var updatedSOSLog = await _sosService.UpdateAsync(id, sosLog);
        ...
        {
            var result = await _sosService.DeleteAsync(id);
